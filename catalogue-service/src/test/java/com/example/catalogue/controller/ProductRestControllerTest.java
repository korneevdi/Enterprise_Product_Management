...
class ProductRestControllerTest {
    ...
    void getProduct_ProductExists_ReturnsProduct() {
        // given
        var product = new Product(1, "Good", "Description");
    ...
    void updateProduct_RequestIsValid_ReturnsNoContent() throws BindException {
        // given
        var payload = new UpdateProductPayload("New good", "New description");
        ...
        verify(this.productService).updateProduct(1, "New good", "New description");
    }
